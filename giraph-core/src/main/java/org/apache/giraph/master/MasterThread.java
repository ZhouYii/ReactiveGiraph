      ...
      if (bspServiceMaster.becomeMaster()) {
        ...
        if (bspServiceMaster.getRestartedSuperstep() !=
          ...
          while (!superstepState.isExecutionComplete()) {
            ...
            // Has opportunity to generate list of dead servers
            ...
            // If a worker failed, restart from a known good superstep
             ...
             TODO: Modifiy this body to find which workers failed and then restart.
             Consume the previously generated list of dead workers here.
              */
